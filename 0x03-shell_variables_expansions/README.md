...
15-rot13: script that encodes and decodes text using the rot13 encryption

16-odd: script that prints every other line from the input, starting with the first line

17-water_and_stir: script that adds the two numbers stored in the environment variables
